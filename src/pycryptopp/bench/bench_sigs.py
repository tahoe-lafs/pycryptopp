...
def bench_sigs(MAXTIME):
    for klass in [ECDSA256, Ed25519, RSA2048, RSA3248]:
        ...
        ob = klass()
        print "generate key"
        rep_bench(ob.gen, 100, UNITS_PER_SECOND=1000, MAXTIME=MAXTIME, MAXREPS=100)
        print "sign"
        rep_bench(ob.sign, 100, UNITS_PER_SECOND=1000, initfunc=ob.sign_init, MAXTIME=MAXTIME, MAXREPS=100)
        print "verify"
